...
const hotels = [
  {
    ...
    facilities: ['Free WiFi', 'Fitness Center', 'Swimming Pool', 'Restaurant', 'Business Center']

  },
  {
    id: 2,
    name: "Lake Side Resort Neermahal",
    images: ["/hotel2.jpg", "/neermahal2.jpg", "/neermahal3.jpg", "/neermahal4.jpg"],
    location: "Rudrasagar",
    price: "₹3,499/night",
    rating: 4.0,
    reviews: 150,
    description: "Beautiful lakeside resort with stunning views.",
    facilities: ['Free Parking', 'Restaurant', 'Bar', 'Room Service', '24/7 Reception']
  },
  {
    id: 3,
    ...
    facilities: ['Free WiFi', 'Restaurant', 'Garden', 'Hiking Trails', '24/7 Reception']
  },
  {
    id: 4,
  ...
  },
  {
    ...
    facilities: ['Free WiFi', 'Restaurant', 'Bar', 'Room Service', '24/7 Reception']
  },
  {
    id: 6,
    name: "The Imperial Hotel",
    images: ["/hotel10.jpeg", "/imperial2.jpg", "/imperial3.jpg", "/imperial4.jpg"],
    location: "Udaipur",
    price: "₹2,199/night",
    rating: 4.0,
    reviews: 60,
  ...
  },
  {
    ...
    rating: 4.2,
    reviews: 80,
    description: "A lakeside resort with beautiful views and comfortable rooms.",
    facilities: ['Free WiFi', 'Restaurant', 'Bar', 'Room Service', '24/7 Reception']
  },
];
...
export default function HotelDetailsPage() {
  ...
  const related = hotels.filter((item) =>
    item.location === hotel.location && item.id !== hotelId
  );
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100">
      ...
      <div className='rounded-md overflow-hidden shadow-md mb-4 relative'>
        ...
        >
          {hotel.images.map((img, idx) => (
            <SwiperSlide key={idx}>
              <Image src={img} alt={`${hotel.name} ${idx}`} width={700} height={500} className='rounded-md object-cover w-full' />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
      ...
      <div className='bg-gray-50 p-4 mt-6 rounded-md shadow-md'>
        ...
        <form onSubmit={handleAddComment} className='flex flex-col mt-4 space-y-4'>
          <input
